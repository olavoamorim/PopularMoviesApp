...
public class MovieResults implements Parcelable{
    ...
    protected MovieResults(Parcel in) {
        ...
        in.readList(this.results, (com.olavo.popularmoviesappv2.Result.class.getClassLoader()));
